//Q9. Design a class ‘Point’ with data members as x and y. The class should have a parameterized constructor to initialize its data members. Define a method distance() which returns the distance between two points.
