//Q5. Write a program to declare a class employee with data members id, name, department, salary. Add a method getData(), putData() to accept and display the details of n employees. Define a Main class to create the objects of employee class and perform basic operations.
