//Q6. Create a Package btech which has one class Student. Accept student detail through parameterized constructor of
//Student class. Write a method display() to display the student details. Create another class Main containing the main
  //      method which will use the package btech and calculate total marks and percentage of marks.
