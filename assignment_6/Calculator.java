//Q2. Define an interface Calculator which has the basic methods add(), sub(), mul() and div(). Define a concrete class
//named as DemoCalculator that implements the interface. Define the Main class, which create object reference of the
//interface Calculator and perform all basic operation of the calculator.
