//Q1. Write a program that creates a class Account that have members accountNumber, customerName. Account has constructor to initialize its members and method display() to show the result. Create a child class SavingsAccount that is derived from Account class. SavingsAccount have members minBalance and savingBalance. Use show() to display its details. Then create another child class AccountDetails from SavingsAccount class have members deposit, withdraw and a method show1() to show its details. Child classes have constructors of their own. Create a Main class that creates a record of customer and display all its details.
